...
YEAR_WORKERS = env_int("MOHKAM_YEAR_WORKERS", max(2, min(6, int(HOST_CPU_COUNT * TARGET_HOST_UTILIZATION))))
DETAIL_CONCURRENCY_PER_YEAR = env_int("MOHKAM_DETAIL_CONCURRENCY_PER_YEAR", max(16, min(48, int(HOST_CPU_COUNT * TARGET_HOST_UTILIZATION * 4))))
GLOBAL_REQUEST_LIMIT = env_int("MOHKAM_GLOBAL_REQUEST_LIMIT", max(32, min(160, int(HOST_CPU_COUNT * TARGET_HOST_UTILIZATION * 12))))
...
MAX_REQUEST_DELAY_SECONDS = env_float("MOHKAM_MAX_REQUEST_DELAY_SECONDS", 0.05)
