...
PIPELINE_DB_FILE = STATE_DIR / "qistas_pipeline.sqlite3"
...
COURT_SHARDS_RAW = os.environ.get("MOHKAM_COURT_SHARDS", "none").strip()
...
INDEX_WORKERS = cap_unless_unsafe(env_int("MOHKAM_INDEX_WORKERS", YEAR_WORKERS), 3)
DETAIL_WORKERS = cap_unless_unsafe(env_int("MOHKAM_DETAIL_WORKERS", DETAIL_CONCURRENCY_PER_YEAR), 48)
DETAIL_CLAIM_BATCH_SIZE = env_int("MOHKAM_DETAIL_CLAIM_BATCH_SIZE", 1)
DETAIL_MAX_ATTEMPTS = env_int("MOHKAM_DETAIL_MAX_ATTEMPTS", 5)
DETAIL_IDLE_SLEEP_SECONDS = env_float("MOHKAM_DETAIL_IDLE_SLEEP_SECONDS", 5.0)
DETAIL_RETRY_BASE_SECONDS = env_float("MOHKAM_DETAIL_RETRY_BASE_SECONDS", 3.0)
DETAIL_WORKER_LOGIN_STAGGER_SECONDS = env_float("MOHKAM_DETAIL_WORKER_LOGIN_STAGGER_SECONDS", 0.25)
BOOTSTRAP_SEEN_KEYS = env_bool("MOHKAM_BOOTSTRAP_SEEN_KEYS", True)
...
YEAR_START_STAGGER_SECONDS = env_float("MOHKAM_YEAR_START_STAGGER_SECONDS", 0.0)
...
EMPTY_PAGE_CONFIRMATIONS = env_int("MOHKAM_EMPTY_PAGE_CONFIRMATIONS", 1)
EMPTY_PAGE_RETRY_SECONDS = env_float("MOHKAM_EMPTY_PAGE_RETRY_SECONDS", 0.0)
UNVERIFIED_EMPTY_PAGE_PAUSE_SECONDS = env_float("MOHKAM_UNVERIFIED_EMPTY_PAGE_PAUSE_SECONDS", 2.0)
UNVERIFIED_EMPTY_PAGE_MAX_RETRIES = env_int("MOHKAM_UNVERIFIED_EMPTY_PAGE_MAX_RETRIES", 5)
RELOGIN_ON_UNVERIFIED_EMPTY = env_bool("MOHKAM_RELOGIN_ON_UNVERIFIED_EMPTY", True)
